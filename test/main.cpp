...
void InputTest(bool& testInputRunning)
{
	...
	modulePlayerTest->Load((char*)"test1.mod");
	modulePlayerTest2->Load((char*)"test2.mod");
	modulePlayerTest3->Load((char*)"test3.mod");
	...
	while (testInputRunning)
	{
		...
		//
		//  Temp message formatting string
		//
		...
		if (SGE::Inputs::Keyboard::Status[SGE::Inputs::Keymap::Z])
		{
			...
			temp = "Master Volume:" + std::to_string(SGE::Sound::MasterVolume) + "\n";
			SGE::System::Message::Output(SGE::System::Message::Levels::Debug, SGE::System::Message::Sources::Sound, temp);
		}
		...
		{
			SGE::Sound::MasterVolume += .01f;
			SGE::System::Message::Output(SGE::System::Message::Levels::Debug, SGE::System::Message::Sources::Sound, "Master Volume: " + std::to_string(SGE::Sound::MasterVolume) + "\n");
		}
